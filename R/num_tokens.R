...
#' @param encoding a character string that specifies how text is converted into
#' tokens. The default is "cl100k_base" (for ChatGPT models; see
...
num_tokens <- function(text, encoding = "cl100k_base") {
  ...
  # Note: this will install the dependency (and Miniconda, if no suitable
  # python installation could be found)
