...
#'
#' This function extracts the object data from the parsed HTTP response of an
#' API call to the OpenAI chat completions endpoint (provides information about
#' the endpoint).
#'
#' @param response a list object representing the HTTP response
#' @return a data frame with the usage statistics of the API call (how many
#' tokens used)
